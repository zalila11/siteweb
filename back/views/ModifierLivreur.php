                ...
                <div class="grid-form">
                    <div class="grid-form1">
                        <form action="EnregisterLiveur.php" method="post">
                            <button type="submit" class="btn btn-default"><h2 id="forms-example" class="">Modifier livreur</h2></button>
                            ...
                            <div class="form-group">
                                <label >Nom</label>
                                <input type="text" name="nom" pattern="[A-Za-z].{3,}" value="<?php echo $singlelivreur[0]["Nom"]?>" title="Au moins 3 Charactéres" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label >Prenom</label>
                                <input type="text" name="prenom" pattern="[A-Za-z].{3,}" value="<?php echo $singlelivreur[0]["Prenom"]?>" title="Au moins 3 Charactéres" class="form-control" required>
                            </div>
                            <div class="form-group">

...
<h2>Liste des catalogues</h2>
	<?PHP
function afficherModifiercatalogue($idcatalogue)
	{
...
$listeCatalogues=$catalogue->affichercatalogue();
$affe=afficherModifiercatalogue($_GET['idcatalogue']);
?>
...
<form method="POST" action="modifiere1.php">
<table>

			<h2>Modifier Catalogue</h2>
<tr>
<td>Code promotion</td>
<td><input type="text" name="idcatalogue" value="<?PHP echo $affe->idcatalogue;?>"></td>
</tr>
<tr>
<td>Nom</td>

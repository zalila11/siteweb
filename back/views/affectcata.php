...
<form method="POST" action="ajoutcataproduit.php">
	<?PHP
include "../core/afficherproduit.php";
...
foreach($listeProduits as $row){
	...
	<tr>
		<td class="a-center ">
                              <input type="checkbox" class="flat" name="<?php echo $name;?>" value="<?php echo $row['nomproduit'];?>">
                            </td>
...
foreach($listeCatalogues as $row){
	?>
	<tr>
		<td><input type="checkbox" name="checkbox" value="<?PHP echo $row['idcatalogue'];?>"name=""></td>

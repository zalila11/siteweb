...
{
$crit=$_POST["critr"];
$listePromotions=$promotion->afficherpromotiontri($crit);
}	
?>
...
<form method="POST" action="#">
	<select name="critr">
		...
		<option value="idpromotion" >Code Promotion</option>
...
<h2>Liste des promotions produits</h2>
	<?PHP
require_once "../core/PromotionProduitP.php";
$promotionproduit=new PromotionProduitP();
$listePromotions=$promotionproduit->ListePromotionProduit();
?>
<table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
...
foreach($listePromotions as $row){
	...
	<td><form method="POST" action="supprimerpromotionproduit.php">

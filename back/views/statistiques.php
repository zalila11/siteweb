...
$db=config::getConnexion();
  ...
  $req1= $db->query("SELECT COUNT(*) as nb1 FROM rendezvous WHERE lieuRen='tunis' "  );
    $nb1 = $req1->fetch();

    $req2= $db->query("SELECT COUNT(*) as nb2 FROM rendezvous WHERE lieuRen='sfax' " );
    $nb2 = $req2->fetch();

    $req3= $db->query("SELECT COUNT(*) as nb3 FROM rendezvous WHERE lieuRen='nabeul' " );
     $nb3 = $req3->fetch();

    $req4= $db->query("SELECT COUNT(*) as nb4 FROM rendezvous WHERE lieuRen='sousse' " );
    $nb4 = $req4->fetch();

      $req5= $db->query("SELECT COUNT(*) as nb5 FROM rendezvous WHERE lieuRen='gabes' " );
    $nb5 = $req5->fetch();

       $req6= $db->query("SELECT COUNT(*) as nb6 FROM rendezvous WHERE lieuRen='mestir' " );
    $nb6 = $req6->fetch();



$dataPoints = array(
  array("label"=> "tunis", "y"=> intval($nb1['nb1'])),
  array("label"=> "sfax", "y"=> intval($nb2['nb2'])),
  array("label"=> "nabeul", "y"=> intval($nb3['nb3'])),
  array("label"=> "sousse", "y"=> intval($nb4['nb4'])),
  array("label"=> "gabes", "y"=> intval($nb5['nb5'])),
  array("label"=> "mestir", "y"=> intval($nb6['nb6'])),
...
var chart = new CanvasJS.Chart("chartContainer", {
  ...
  title:{
    text: "Statistique des lieux des rendez-vous"
  },
  data: [{
...
<!--heder end here-->
<ol class="breadcrumb">
 <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Gestion rendez_vous</li>
</ol>

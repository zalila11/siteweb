...
require "../core/modifierpromotion.php";
if (isset($_GET['idpromotion']))
{
	$promotions=new promotion();
    $result=$promotions->recupererpromotion($_GET['idpromotion']);
...
<center>
	<form method="post" >
		code  promotion: <input type="text" name="idpromotion" value="<?php echo $idpromotion ?>" required="" > </br><br>
		Nom: <input type="text" name="nom" value="<?php echo $nom ?>"  required="" > </br><br>
		date debut: <input type="text" name="datedebut" value="<?php echo $datedebut ?>"  required="" > </br><br>
		Date fin: <input type="text" name="datefin" value="<?php echo $datefin ?>"  required="" > </br><br>
		pourcentage: <input type="text" name="pourcentage" value="<?php echo $pourcentage ?>"  required=""> </br><br>
		
		<input type="submit" name="modifier" value="modifier">
		<input type="hidden" name="ID" value="<?PHP echo $_GET['idpromotion'];?>">
		<a href="listepromotion.php"><input type="button" name="Retour a la liste" value="Retour a la liste"></a>
...
{
	$employe=new promotion($_POST['idpromotion'],$_POST['nom'],$_POST['datedebut'],$_POST['datefin'],$_POST['pourcentage']);
	$promotions->modifierpromotion($employe,$_POST['idpromotion']);
	echo $_POST['idpromotion'];

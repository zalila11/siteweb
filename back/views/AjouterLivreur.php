            ...
            <div class="mother-grid-inner">
                ...
                <div class="grid-form">
                    <div class="grid-form1">
                        <form action="InsererLivreur.php" method="post">
                            <button type="submit" class="btn btn-default">    <h2 id="forms-example" class="">Ajouter livreur</h2></button>
                            <div class="form-group">
                                <label >CIN</label>
                                <input type="text" name="cin" pattern="[0-9]{8}" title="8 chiffres pour le CIN" class="form-control" required>
                            </div>

                            <div class="form-group">
                                <label >Nom</label>
                                <input type="text" name="nom" pattern="[A-Za-z].{3,}" title="Au moins 3 Charactéres" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Prenom</label>
                            <input type="text" name="prenom" pattern="[A-Za-z].{3,}" title="Au moins 3 Charactéres" class="form-control" required>

                            </div>
                            <div class="form-group">
                                <label >Date d'anniversaire</label>
                                <input class="form-control" name="datenaiss" max="1995-01-01" type="date" required>
                            </div>

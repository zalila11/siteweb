                        ...
                        <div class="w3l-table-info">
                            ...
                            <table id="table">
                                ...
                                <?php foreach ($livraisons as $livraison) { ?>
                                    ...
                                    <td><a href="ModifierLivraison.php?ref=<?php echo $livraison["ID_Livraison"] ;?>" >Modifier</a> </td>
                                    <td><a href="DeleteLivraison.php?ref=<?php echo  $livraison["ID_Livraison"] ;?>" >Supprimer</a> </td>

...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>profil</li>
            </ol>
<!--grid-->
 	...
 	<!---->
        ...
        <form method="post" action="modifierprofil.php">
            ...
            <div class="col-md-6 form-group1">
              ...
              <input type="text" placeholder="" required="" name="" value="<?php echo $_SESSION['identifiant'];?>" disabled>
              <input type="hidden" value="<?php echo $_SESSION['identifiant'];?>" name="id">
            </div>
            <div class="clearfix"> </div>
            </div>
            ...
            <div class="col-md-12 form-group1 group-mail">
              ...
              <input type="text" placeholder="" required="" name="mdp" value="<?php echo $_SESSION['motdepasse'];?>">
            </div>
             <div class="clearfix"> </div>

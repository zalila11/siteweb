            ...
            <div class="mother-grid-inner">
                ...
                <div class="grid-form">
                    <div class="grid-form1">
                        ...
                        <button type="submit" class="btn btn-default">    <h2 id="forms-example" class="">Ajouter une livraison</h2></button>
                            ...
                            <div class="form-group">
                                ...
                                <select name="commande" class="form-control" >
                                    <?php foreach ($livraisons as $livraison) { ?>
                                        <option value="<?php echo $livraison["idcommande"] ?>"><?php echo $livraison["cin"]?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <div class="form-group">

...
<div class="agile-grids">	
	...
	<h2>Liste des Rendez_vous</h2>
	<?PHP
include "../core/afficherRendezvous.php";
$rendezvous=new rendezvousa();
$listeRendezvouss=$rendezvous->afficherRendezvous();
?>
<table border="3">
<tr>
<th>Nom Rendez_vous</th>
<th>lieu Rendez_vous</th>
...
foreach($listeRendezvouss as $row){
	...
	<input type="hidden" value="<?PHP echo $row['nomRen']; ?>" name="nomRen">
	</form>
	<td><a href="modifierRen.php?nomRen=<?PHP echo $row['nomRen']; ?>">

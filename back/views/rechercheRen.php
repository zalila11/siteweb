              ...
              <!--header start here-->
				<div class="header-main">
					<div class="logo-w3-agile">
								<h1><a href="index.html">Mer bleue</a></h1>
							</div>
...
<h2>Rechercher un Rendez_vous</h2>
	<?PHP
include "../core/rechercherRendezvous.php";
$rendezvous=new rendezvousre();
//echo ($_POST["rech"]);
$n=$_POST["rech"];
$listeRendezvouss=$rendezvous->rechercherRendezvous($n);
...
<td>Nom Rendez_vous</td>
<td>lieu Rendez_vous</td>
<td>date Rendez_vous</td>

</tr>
<?PHP
foreach($listeRendezvouss as $row){
	?>
	<tr>
	
	<td><?PHP echo $row['nomRen']; ?></td>
	<td><?PHP echo $row['lieuRen']; ?></td>
	<td><?PHP echo $row['dateRen']; ?></td>
	</tr>
	<?PHP
}
?>
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									...
									<li id="menu-academico" ><a href="afficherRec.php"><i class="fa fa-list-ul" aria-hidden="true"></i><span> Gestion reclamation</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
										   ...
										   <li id="menu-academico-avaliacoes" ><a href="icons.php">recherche reclamation</a></li>
									...
									<li id="menu-academico" ><a href="afficherRen.php"><i class="fa fa-list-ul" aria-hidden="true"></i><span> Gestion rendez_vous</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
										   <ul id="menu-academico-sub" >
										   <li id="menu-academico-avaliacoes" ><a href="rendezz.php">recherche rendez_vous</a></li>

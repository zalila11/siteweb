...
<?PHP
 ...
 function afficherModifierpromotion($idpromotion)
	{
...
$affe=afficherModifierpromotion($_GET['idpromotion']);
?>
...
<tr>
<td>Code promotion</td>
<td><input type="text" name="idpromotion"  value="<?PHP echo $affe->idpromotion;?>" disabled="true"></td>
</tr>
<tr>
<td>Nom</td>
<td><input type="text" name="nom" value="<?PHP echo $affe->nom;?>"></td>
</tr>
<tr>
<td>Date Debut</td>
<td><input type="text" name="datedebut" value="<?PHP echo $affe->datedebut;?>"></td>
</tr>
<tr>
<td>Date Fin</td>
<td><input type="text" name="datefin" value="<?PHP echo $affe->datefin;?>"></td>
</tr>
<tr>
<td>Pourcentage</td>
<td><input type="text" name="pourcentage" value="<?PHP echo $affe->pourcentage;?>"></td>
</tr>
<tr>
                           ...
                           <div class="menu">
									 ...
									 <li><a href="tabels.html"><i class="fa fa-table"></i>  <span>Gestion livraison</span><div class="clearfix"></div></a></li>
									  <li id="menu-academico" ><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span> Gestion promotion</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
										   ...
										   <li id="menu-academico-avaliacoes" ><a href="pajouter.php">Ajouter</a></li>
											<li id="menu-academico-avaliacoes" ><a href="pmodifier.php">Modifier</a></li>
									...
									<li id="menu-academico" ><a href="catalogue.php"><i class="fa fa-list-ul" aria-hidden="true"></i><span> Gestion catalogue</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
										   ...
										   <li id="menu-academico-avaliacoes" ><a href="cajouter.php">Ajouter</a></li>
											<li id="menu-academico-avaliacoes" ><a href="cmodifier.php">Modifier</a></li>
											<li id="menu-academico-avaliacoes" ><a href="psupprimer.php">Supprimer</a></li>
											<li id="menu-academico-avaliacoes" ><a href="prechercher.php">Rechercher</a></li>
										  </ul>
										</li>

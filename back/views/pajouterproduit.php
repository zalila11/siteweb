...
<div class="agile3-grids">
	  <div class="agile-tables">
          <div class="w3l-table-info">
            <div class="agile-tables">
<h2 align="middle">Gestion Du Produit</h2>
...
<th>Quantiet</th>
<th>Prix</th>
<th colspan="2"><p align="middle">Actions</p></th>
</tr>
<?PHP
foreach($listeProduits as $row){
	...
	<td><p><a href="formmodifier.php?idproduit=<?PHP echo $row['idproduit']; ?>"><button>Modifier</button></a></p></td>

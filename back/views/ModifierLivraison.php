...
$singlelivraison=$livraison->getLivraison($_GET["ref"]);
            ...
            <div class="mother-grid-inner">
                ...
                <div class="grid-form">
                    <div class="grid-form1">
                        <form action="EnregistrerLivraison.php" method="post">
                            <button type="submit" class="btn btn-default">    <h2 id="forms-example" class="">Modify Delivery  Status</h2></button>
                            <div class="form-group">
                                <label >ID Livreur</label>
                                <input type="text" name="cin" value="<?php echo $singlelivraison[0]["ID_Livreur"]?>" title="8 chiffres pour le CIN" class="form-control" disabled>
                            </div>

                            <div class="form-group">
                                <label >ID Commande</label>
                                <input type="text" name="nom"  value="<?php echo $singlelivraison[0]["ID_Commande"]?>" title="Au moins 10 Charactéres" class="form-control" disabled>
                            </div>
                            <div class="form-group">
                                <label >Montant</label>
                                <input type="text" name="prenom"  value="<?php echo $singlelivraison[0]["Montant"]?>" title="Au moins 10 Charactéres" class="form-control" disabled>
                            </div>
                            <div class="form-group">
                                <label > Date</label>
                                <p class="form-control"  ><?php echo $singlelivraison[0]["Date"]?></p>
                            </div>
                            <div class="form-group">
                                <label > Adresse</label>
                                <p class="form-control"  ><?php echo $singlelivraison[0]["Adresse"]?></p>
                            </div>
                            <div class="form-group">
                                <label > Status</label>
                                <input class="form-control" name="status" value="Termine" type="radio" checked>Terminé
                                <input class="form-control" name="status" value="En Livraison" type="radio">En Livraison
                            </div>
                            <input name="id" value="<?php echo $singlelivraison[0]["ID_Livraison"]?>" type="hidden">
                        </form>
                    </div>
                    <!----->
                </div>

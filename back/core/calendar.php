...
<!--heder end here-->
		<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Gestion promotion</li>
            </ol>

	<div class="grids">
	<h2>Liste des promotions</h2>
	<?PHP 
	include "../core/affichagepromotion.php" ; 
$promotion=new prmotiona() ; 

...
$singlelivreur=$livreur->Getlivreur($_GET["ref"]);
            ...
            <div class="mother-grid-inner">
                ...
                <div class="grid-form">
                    <div class="grid-form1">
                        <form action="EnregisterLiveur.php" method="post">
                            <button type="submit" class="btn btn-default"><h2 id="forms-example" class="">Modify Deliver Man Status</h2></button>
                            <div class="form-group">
                                <label >CIN</label>
                                <input type="text" name="cin" pattern="[0-9]{8}" value="<?php echo $singlelivreur[0]["CIN"]?>" title="8 chiffres pour le CIN" class="form-control" required>
                            </div>

                            <div class="form-group">
                                <label >Name</label>
                                <input type="text" name="nom" pattern="[A-Za-z].{3,}" value="<?php echo $singlelivreur[0]["Nom"]?>" title="Au moins 10 Charactéres" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label >First Name</label>
                                <input type="text" name="prenom" pattern="[A-Za-z].{3,}" value="<?php echo $singlelivreur[0]["Prenom"]?>" title="Au moins 10 Charactéres" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label > Birth Date</label>
                                <input class="form-control" name="datenaiss" value="<?php echo $singlelivreur[0]["Date_Naiss"]?>" type="date" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="status">
                                    ...
                                    <option value="Conge">Conge
                                    </option>
                                    <option value="En Livraison">Livraison
                                    </option>
                                </select>
                            </div>
                            <input name="id" value="<?php echo $singlelivreur[0]["ID_Livreur"]?>" type="hidden">
                        </form>
                    </div>
                    <!----->
                </div>

...
$livreurs=$livraisonCore->getListLivreurs();
?>
    <!--
      Author: W3layouts
                ...
                <div class="agile-grids">
                    ...
                    <div class="agile-tables">
                        <div class="w3l-table-info">
                            <h2>Deliver Mans Data Tables</h2>
                            <table id="table">
                                <thead>
                                <tr>
                                    <th>ID</th>
                                ...
                                <?php foreach ($livreurs as $livreur) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo $livreur["Date"] ;?></td>
                                        <td><?php echo $livreur["Date_Naiss"] ;?></td>
                                        <td><?php echo $livreur["Status"] ;?></td>
                                        <td><a href="ModifierLivreur.php?ref=<?php echo $livreur["ID_Livreur"] ;?>" >Edit</a> </td>
                                        <td><a href="DeleteLivreur.php?ref=<?php echo $livreur["ID_Livreur"] ;?>" >Delete</a> </td>
                                    </tr>
                                <?php } ?>
                                </tbody>
                            </table>

...
$livreurs=$livraisonCore->GetlivreurLibre();

$livraisons=$livraisonCore->getListCommandes();
            ...
            <div class="mother-grid-inner">
                ...
                <div class="grid-form">
                    <div class="grid-form1">
                        <form action="InsererLivraison.php" method="post">
                        <button type="submit" class="btn btn-default">    <h2 id="forms-example" class="">Add A Delivery</h2></button>
                            <div class="form-group">
                                <label >Deliver Man</label>
                                <select name="livreur" class="form-control" >
                                    <?php foreach ($livreurs as $livreur) { ?>
                                        <option value="<?php echo $livreur["ID_Livreur"] ?>"><?php echo $livreur["Nom"]?></option>
                                    <?php } ?>
                                </select>
                            </div>

                            <div class="form-group">
                                <label >Order To Affect</label>
                                <select name="commande" class="form-control" >
                                    <?php foreach ($livraisons as $livraison) { ?>
                                        <option value="<?php echo $livraison["ID_commande"] ?>"><?php echo $livraison["Nom_Client"]." ". $livraison["Montant"]." TND"?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <div class="form-group">

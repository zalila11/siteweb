                ...
                <div class="grid-form">
                    <div class="grid-form1">
                        <form action="InsererLivreur.php" method="post">
                            <button type="submit" class="btn btn-default">    <h2 id="forms-example" class="">Add A Deliver Man</h2></button>
                            ...
                            <div class="form-group">
                                <label >Name</label>
                                <input type="text" name="nom" pattern="[A-Za-z].{3,}" title="Au moins 10 Charactéres" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label >First Name</label>
                            <input type="text" name="prenom" pattern="[A-Za-z].{3,}" title="Au moins 10 Charactéres" class="form-control" required>

                            </div>
                            <div class="form-group">
                                <label >Birth Date</label>
                                <input class="form-control" name="datenaiss" max="1998-12-31" type="date">
                            </div>

...
$listeWishlists=$wishlist;
if (isset($_POST["critr"]))
{
$crit=$_POST["critr"];
$listeWishlists=$wishlist->afficherwishlisttri($_SESSION['cin'],$crit);
}
?>
<h4 align="left" >Choisissez Le Critere De Tri</h4>
<form method="POST" action="#" align="left">
	<select name="critr"  >
		<option value="nomproduit">Nom</option>
		<option value="quantitep" >Quantite</option>
		</select>

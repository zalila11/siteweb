...
$livraisons=$livraison->getLivraisonClient($_SESSION["cin"]);
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<div class="cart-items">
		<div class="container">
			<h3 class="wow fadeInUp animated" data-wow-delay=".5s">My Deliveries</h3>
            <?php foreach ($livraisons as $livraison) { ?>
			<div class="cart-header wow fadeInUp animated" data-wow-delay=".5s">
				<div class="cart-sec simpleCart_shelfItem">
					<div class="cart-item-info">
						<h4><a>ID De La livraison : #<?php echo $livraison["ID_Livraison"]  ;?> </a></h4>
						<ul class="qty">
							<li><p>Date D'ajout : <?php echo $livraison["Date"];?></p></li>
							<li><p>Montant : <?php echo $livraison["Montant"]." TND"  ;?></p></li>
						</ul>
						<div class="delivery">
							<p>L'etat de Cette Livraison : <?php echo $livraison["Etat"]  ;?></p>
                            <?php if($livraison["Etat"]=="En Livraison") { ?>
                                <span>Confirmer : <a href="ConfirmerLivraison.php?id=<?php echo $livraison["ID_Livraison"]  ;?>" class="btn btn-primary btn-sm">Recu ?</a>
                                </span>
                            <?php }else if ($livraison["Etat"]=="Recu") { ?>  <span>Terminé </span>
                            <?php } ?>
						</div>
					</div>
					<div class="clearfix"></div>

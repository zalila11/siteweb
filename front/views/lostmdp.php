...
<body>
	...
	<div class="login-page">
		<div class="title-info wow fadeInUp animated" data-wow-delay=".5s">
			<h3 class="title">Mot de passe<span> oublié</span></h3>
			<p> </p>
		</div>
		<div class="widget-shadow">
			...
			<div class="login-body wow fadeInUp animated" data-wow-delay=".7s">
				<form class="wow fadeInUp animated" data-wow-delay=".7s" method="POST" action="mail.php">
					<input type="text" class="user" name="mail" placeholder="Adresse mail" required="">
					<input type="text" name="cin" class="lock" required="" placeholder="Cin">

...
<body>
	...
	<div class="reclamation">	 
		<div class="containers">
			...
			<h4><center>Passer une reclamation</center></h4>
		</br>
		</br>
		</br>
			...
			<div class="address-row">
				<div class="col-md-6 address-left wow fadeInLeft animated" data-wow-delay=".5s">
					<div class="address-grid">
						<h4 class="wow fadeIndown animated" data-wow-delay=".5s">Passer une reclamation</h4>
						
						<form method="POST" action="ajoutReclamation.php">
							<input class="wow fadeIndown animated" data-wow-delay=".6s" type="text" name="nomRec" placeholder="Nom hotel ou restaurant" required="">
							...
							<input class="wow fadeIndown animated" data-wow-delay=".8s" type="text" name="sujetRec" placeholder="Sujet" required="">
							<textarea class="wow fadeIndown animated" data-wow-delay=".8s" placeholder="Message" name="messageRec" required=""></textarea>
							<input class="wow fadeIndown animated" data-wow-delay=".9s" type="submit" value="Envoyer" name="ajouter">


							
						</form>
						<form action="rendezvous.php">
						<input class="wow fadeIndown animated" data-wow-delay=".9s" type="submit" value="Prendre un rendez-vous" >
					</form>
					</div>
				</div>
					...
					<div class="address-info wow fadeInRight animated" data-wow-delay=".5s">
						<h4>ADRESSE</h4>
						<p>Soukra chotrana 1 tunis,tunisia.</p>
					</div>
					...
					<div class="address-info wow fadeInRight animated" data-wow-delay=".6s">
						<h4>MAIL</h4>
						<p><a href="mailto:example@mail.com">Mer.blue@hotmail.com</a></p>
					</div>
				</div>
			</div>	
		</div>	

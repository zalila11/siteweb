...
<body>
	...
	<div class="login-page">
		<div class="title-info wow fadeInUp animated" data-wow-delay=".5s">
			<h3 class="title">Profil<span> Client</span></h3>
			<p></p>
		</div>
		...
		<div class="widget-shadow">
			<div class="login-body">
						...
						Nomclient<input type="text" value="<?php echo $_SESSION['nomclient'];?>" required="" name="nomclient">
						Nom hotel ou restaurant<input type="text" value="<?php echo $_SESSION['nomcommerce'];?>" required="" name="nomcommerce">
						Numéro carte d'identité<input type="text" value="<?php echo $_SESSION['cin'];?>" required="" name="" disabled>
						<input type="hidden" value="<?PHP echo $_SESSION['cin']; ?>" name="cin">
						Adresse mail<input type="text" class="email" value="<?php echo $_SESSION['mail'];?>" required="" name="mail">
						Telephone<input type="text" value="<?php echo $_SESSION['telephone'];?>" required="" name="telephone">
						Adresse hotel ou restaurant<input type="text" value="<?php echo $_SESSION['adresse'];?>" required="" name="adresse">
						Mot de passe<input type="text" class="lock" value="<?php echo $_SESSION['motdepasse'];?>" required="" name="motdepasse">

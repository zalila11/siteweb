...
require_once "../../config.php"; 
 $db=config::getConnexion();
  ...
  $req1= $db->query("SELECT  COUNT(*) as nb1  from wishlist where (  quantitep >=50)  " );
    $nb1 = $req1->fetch();

    $req2= $db->query("SELECT  COUNT(*) as nb2  from wishlist where (  quantitep <=50)  " );
    $nb2 = $req2->fetch();

    
$dataPoints = array(
  array("label"=> "Quantite Plus Que 50", "y"=> intval($nb1['nb1'])),
  array("label"=> "Quantite Moins Que 50", "y"=> intval($nb2['nb2'])),
);
?>
<script>
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	title:{
		text: "Stat Par Rapport Quantite"
	},
	data: [{

...
<div class="new">
		<div class="container">
			<div class="title-info wow fadeInUp animated" data-wow-delay=".5s">
				<h3 class="title">PROD<span>UITS</span></h3>
				<p>Produits</p>

		<?php   if(isset($_SESSION['cin'])) 
{?>
				<h1 align="middle"><a href="Wishlist.php">Wishlist</a><h1>
					<?php
}?>
			</div>
			<div class="new-info">
				...
				<div class="col-md-3 new-ergrid simpleCart_shelfItem wow flipInY animated" data-wow-delay=".5s">

					<div class="new-top">
						<input type="hidden" value="<?PHP echo $row['nomproduit']; ?>" name="nomproduit">
						
						<a href="single.php?idproduit=<?PHP echo $row['idproduit'];?>"><img  src=<?php echo "'images/".$row['nomproduit'].".jpg'"?> class="img-responsive" /></a>
					...
					<div class="ofr">
							<p><span class="item_name"><?php echo $row['nomproduit'] ?></span></p>
						</div>
						<div class="ofr">
							<p><span class="item_price"><?php echo $row['prix']."DT" ?></span></p>
						</div>
					</div>
					<div class="new-bottom">
						<h5><a class="name" href="single.html"><?php echo $row['quantite']." Kg"?> </a></h5>
						<p><span class="name" href="single.html"><?php echo " A Consommer avant le " .$row['datev']?> </span></p>
						
	<input type="hidden" value="<?PHP $name=$row['nomproduit']; ?>" name="nomproduit">			
...
<div class="new-bottom">
		...
		<?php   if(isset($_SESSION['cin'])) 
{?>
	<h5><a href="ajouterwishlist.php?idproduit=<?PHP echo $row['idproduit'];?>" >
...
<h5><a href="single.php?idproduit=<?PHP echo $row['idproduit'];?>" >

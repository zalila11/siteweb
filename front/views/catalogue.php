...
<body>
	...
	<?PHP
						require_once "../core/affichagecatalogue.php";
						$catalogue=new catalogueaf();
						$listeCatalogue=$catalogue->affichercataloguee();
						?>
						<?PHP $e=0; 
...
<div class="new">
		...
		<div class="container">
			...
			<div class="title-info wow fadeInUp animated" data-wow-delay=".5s">
				...
				<h3 class="title"><p><?php echo $row['nom']?></p></h3>
			...
			<?php }$e++;?>
				<div class="col-md-3 new-grid simpleCart_shelfItem wow flipInY animated" data-wow-delay=".5s">
					...
					<div class="new-bottom">
						...
						<div class="ofr">
							<p><span class="item_price"><?php echo "DT".$row['nom'] ?></span></p>
						</div>
					</div>
				</div>
				<?php } ?>

...
<body>
	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">Rendez_vous</li>
			</ol>
		</div>
	</div>
	<!--//breadcrumbs-->
	...
	<div class="rendezvous">	 
		<div class="containers">
			...
			<h4><center>Passer un Rendez_vous</center></h4>
		</br>
		</br>
		</br>
			...
			<div class="address-row">
				<div class="col-md-6 address-left wow fadeInLeft animated" data-wow-delay=".5s">
					<div class="address-grid">
						<h4 class="wow fadeIndown animated" data-wow-delay=".5s">Passer un Rendez_vous</h4>
						
						<form method="POST" action="ajoutRendezvous.php">
							<input class="wow fadeIndown animated" data-wow-delay=".6s" type="text" name="nomRen" placeholder="Nom hotel ou restaurant" required="">
				           
				            <h4><center>Date du Rendez_vous</center></h4>
				            </br>
							<input class="wow fadeIndown animated" data-wow-delay=".8s" type="date" name="dateRen" placeholder="date" required="">
                             </br>
                             </br>

							<input class="wow fadeIndown animated" data-wow-delay=".7s" type="text" name="lieuRen" placeholder="lieu" required="">
